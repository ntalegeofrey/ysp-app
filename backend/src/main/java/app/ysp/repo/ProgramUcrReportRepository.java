...
public interface ProgramUcrReportRepository extends JpaRepository<ProgramUcrReport, Long> {
    ...
    @Query("select r from ProgramUcrReport r where r.program.id = :programId and (r.resolved = false or r.resolved is null) and (r.securityRadiosCondition like '%Critical%' or r.securityRadiosCondition like '%High%' or r.securityFlashlightsCondition like '%Critical%' or r.securityFlashlightsCondition like '%High%' or r.securityMetalDetectorCondition like '%Critical%' or r.securityMetalDetectorCondition like '%High%' or r.securityBigSetKeysCondition like '%Critical%' or r.securityBigSetKeysCondition like '%High%' or r.securityFirstAidKitsCondition like '%Critical%' or r.securityFirstAidKitsCondition like '%High%' or r.securityDeskComputerCondition like '%Critical%' or r.securityDeskComputerCondition like '%High%' or r.adminMeetingRoomsLockedCondition like '%Critical%' or r.adminMeetingRoomsLockedCondition like '%High%' or r.adminDoorsSecureCondition like '%Critical%' or r.adminDoorsSecureCondition like '%High%' or r.infraBackDoorCondition like '%Critical%' or r.infraBackDoorCondition like '%High%' or r.infraEntranceExitDoorsCondition like '%Critical%' or r.infraEntranceExitDoorsCondition like '%High%' or r.infraSmokeDetectorsCondition like '%Critical%' or r.infraSmokeDetectorsCondition like '%High%' or r.infraWindowsSecureCondition like '%Critical%' or r.infraWindowsSecureCondition like '%High%' or r.infraLaundryAreaCondition like '%Critical%' or r.infraLaundryAreaCondition like '%High%' or r.infraFireExtinguishersCondition like '%Critical%' or r.infraFireExtinguishersCondition like '%High%' or r.infraFireAlarmCondition like '%Critical%' or r.infraFireAlarmCondition like '%High%') order by r.reportDate desc, r.id desc")
